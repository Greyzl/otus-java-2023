...
public class ClientCreatorService implements AppRunner {
    ...
    public ClientCreatorService(TransactionRunner transactionRunner, DbExecutor dbExecutor){
...
// Код дальше должен остаться
        ...
        for (int i = 0; i < 5000; i++){
            Client client = dbServiceClient.saveClient(new Client("Client_" + i));
